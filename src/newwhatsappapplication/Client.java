package newwhatsappapplication;
//package messageappplication;
import javax.swing.*;
...
public class Client  implements ActionListener {
    ...
    Client(){
      ...
      morevert.setBounds(410, 20, 9, 25);
      p1.add(morevert);
      
      JLabel name = new JLabel("DIVYA");
      ...
      status.setBounds(140, 40, 100, 18);
     ...
     f.add(a1);
      ...
      send.setFont(new Font("SAN_SARIF", Font.BOLD, 14));
      f.add(send);
